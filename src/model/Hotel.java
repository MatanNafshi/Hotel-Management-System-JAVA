...
public class Hotel  implements Serializable {
    ...
    public boolean removeCustomer(Customer customer) {
        if (customer == null)
            return false;
        if (allCustomers.containsValue(customer)) {
            Iterator<Map.Entry<String, Customer>> iterator = allCustomers.entrySet().iterator();
    ...
    public boolean removeVIPCustomer(VIPCustomer vipCustomer) {
        ...
        if (allCustomers.containsValue(vipCustomer)) {
            ...
            while (iterator.hasNext()) {
                Map.Entry<String, Customer> entry = iterator.next();
                if (entry.getValue().equals(vipCustomer)) {
                    iterator.remove();
                    return true;
                }
            }
    ...
    public List<Employee> KEmployees(int k){
    	if (allEmployees.isEmpty()) {
            return new ArrayList<>(); // Return an empty list if there are no employees
    	}
 ...
 // Inside the Hotel class
    public void copyData(Hotel other) {
        this.allDepartments = other.allDepartments;
        this.allEmployees = other.allEmployees;
        this.allCustomers = other.allCustomers;
        this.allBookings = other.allBookings;
    }
