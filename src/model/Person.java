...
public class Person implements Comparable<Person>, Serializable{
	...
	public Person(String id2, String firstName2, String lastName2) {
		this.id=id2;
	...
	public String toString() {
		return "Person [id="+getId()+" name="+getFirstName()+" "+getLastName()+" , phoneNumber="+getPhoneNumber()+
				", area="+getArea()+", gender="+getGender()+", yearOfBirth="+getYearOfBirth()+"]";
	}
